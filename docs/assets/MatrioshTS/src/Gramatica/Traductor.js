...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,5],$V1=[1,6],$V2=[1,7],$V3=[1,8],$V4=[5,9,11,12,13,14],$V5=[1,20],$V6=[18,21],$V7=[1,28],$V8=[1,29],$V9=[1,30],$Va=[1,31],$Vb=[1,32],$Vc=[1,36],$Vd=[8,18,21];
var parser = {trace: function trace () { },
yy: {},
symbols_: {"error":2,"INICIO":3,"LISTA_INSTRUCCIONES":4,"EOF":5,"INSTRUCCION":6,"BLOQUE":7,"llaveizq":8,"llaveder":9,"FUNCION":10,"multi_linea":11,"identificador":12,"otracosa":13,"pr_function":14,"parizq":15,"F":16,"L_PARAMETROS":17,"parder":18,"dospuntos":19,"TIPO":20,"coma":21,"PARAMETRO":22,"pr_number":23,"pr_string":24,"pr_boolean":25,"pr_void":26,"pr_type":27,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",8:"llaveizq",9:"llaveder",11:"multi_linea",12:"identificador",13:"otracosa",14:"pr_function",15:"parizq",18:"parder",19:"dospuntos",21:"coma",23:"pr_number",24:"pr_string",25:"pr_boolean",26:"pr_void",27:"pr_type"},
productions_: [0,[3,2],[4,2],[4,1],[7,3],[7,2],[6,1],[6,2],[6,2],[6,2],[10,4],[16,5],[16,4],[17,3],[17,1],[22,3],[20,1],[20,1],[20,1],[20,1],[20,1]],
...
case 5:
 this.$ = []; 
break;
case 6: case 10: case 16: case 17: case 19: case 20:
 this.$ = $$[$0]; 
break;
case 9:
...
case 12:
		...
		this.$ = new Funcion(parent,[],$$[$01],_$[$0-3].first_line,_$[$0-3].first_column);  
...
table: [{3:1,4:2,6:3,10:4,11:$V0,12:$V1,13:$V2,14:$V3},{1:[3]},{5:[1,9],6:10,10:4,11:$V0,12:$V1,13:$V2,14:$V3},o($V4,[2,3]),o($V4,[2,6]),{6:11,10:4,11:$V0,12:$V1,13:$V2,14:$V3},{6:12,10:4,11:$V0,12:$V1,13:$V2,14:$V3},{6:13,10:4,11:$V0,12:$V1,13:$V2,14:$V3},{12:[1,14]},{1:[2,1]},o($V4,[2,2]),o($V4,[2,7]),o($V4,[2,8]),o($V4,[2,9]),{15:[1,15]},{12:$V5,16:16,17:17,18:[1,18],22:19},o($V4,[2,10]),{18:[1,21],21:[1,22]},{19:[1,23]},o($V6,[2,14]),{19:[1,24]},{19:[1,25]},{12:$V5,22:26},{20:27,23:$V7,24:$V8,25:$V9,26:$Va,27:$Vb},{20:33,23:$V7,24:$V8,25:$V9,26:$Va,27:$Vb},{20:34,23:$V7,24:$V8,25:$V9,26:$Va,27:$Vb},o($V6,[2,13]),{7:35,8:$Vc},o($Vd,[2,16]),o($Vd,[2,17]),o($Vd,[2,18]),o($Vd,[2,19]),o($Vd,[2,20]),o($V6,[2,15]),{7:37,8:$Vc},o($V4,[2,12]),{4:38,6:3,9:[1,39],10:4,11:$V0,12:$V1,13:$V2,14:$V3},o($V4,[2,11]),{6:10,9:[1,40],10:4,11:$V0,12:$V1,13:$V2,14:$V3},o($V4,[2,5]),o($V4,[2,4])],
...
rules: [/^(?:[/][*][^*]*[*]+([^/*][^*]*[*]+)*[/])/,/^(?:number\b)/,/^(?:string\b)/,/^(?:boolean\b)/,/^(?:void\b)/,/^(?:type\b)/,/^(?:function\b)/,/^(?:\()/,/^(?:\))/,/^(?:\{)/,/^(?:\})/,/^(?:([a-zA-Z])[a-zA-Z0-9_]*)/,/^(?:$)/,/^(?:.)/],
